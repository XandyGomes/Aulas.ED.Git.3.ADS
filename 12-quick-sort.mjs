...
function quickSort(vetor, ini = 0, fim = vetor.length - 1) {
    ...
    quickSort(vetor, ini, div - 1)  // Parâmetros: vetor, início e fim da região a ser ordenada (subvetor à esquerda do pivô)

    // Chama o Quick Sort para o subvetor à direita do pivô
    quickSort(vetor, div + 1, fim) // Parâmetros: vetor, início e fim da região a ser ordenada (subvetor à direita do pivô)
}
